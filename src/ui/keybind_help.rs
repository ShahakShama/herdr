    ...
    let mut groups = vec![
        ...
        (
            ...
            vec![
                ...
                help_entry("b", "open the PR agent and run /bty"),
                help_entry("alt+w / alt+W", "open the PR in Graphite / Reviewable"),
        ...
        (
            ...
            vec![
                ...
                help_entry("p", "open an agent by PR number"),
                help_entry("alt+w / alt+W", "open the branch's PR in Graphite / Reviewable"),
        ...
        (
            ...
            vec![
                ...
                help_entry("alt+d", "review the branch vs origin (incl. uncommitted)"),
